...
class Vpc_Template_Paragraphs_Component extends Vpc_Paragraphs_Component
{
    public static function getSettings()
    {
        ...
        $ret['generators']['paragraphs']['component']['textImage'] = 'Vpc_TextImage_Component';
        $ret['generators']['paragraphs']['component']['image'] = 'Vpc_Basic_Image_Component';
        $ret['generators']['paragraphs']['component']['imagesEnlarge'] = 'Vpc_Composite_ImagesEnlarge_Component';
        ...
        $ret['generators']['paragraphs']['component']['googlemap'] = 'Vpc_Advanced_GoogleMap_Component';
