<?php
class Vpc_iPhone_TextImage_ImageEnlarge_Component extends Vpc_TextImage_ImageEnlarge_Component
{
    public static function getSettings()
    {
        ...
        $ret['generators']['child']['component']['linkTag'] = 'Vpc_iPhone_TextImage_ImageEnlarge_LinkTag_Component';
        return $ret;
    }
}
