<?php
class Vpc_iPhone_Paragraphs_Component extends Vpc_Paragraphs_Component
{
    public static function getSettings()
    {
        $ret = parent::getSettings();
        $ret['generators']['paragraphs']['component'] = array();
        $ret['generators']['paragraphs']['component']['textImage'] = 'Vpc_iPhone_TextImage_Component';
        $ret['generators']['paragraphs']['component']['image'] = 'Vpc_iPhone_Basic_Image_Component';
        $ret['generators']['paragraphs']['component']['imagesEnlarge'] = 'Vpc_iPhone_Composite_ImagesEnlarge_Component';
        ...
        $ret['generators']['paragraphs']['component']['contact'] = 'Vpc_iPhone_Contact_Component';
        $ret['generators']['paragraphs']['component']['googlemap'] = 'Vpc_iPhone_Advanced_GoogleMap_Component';
